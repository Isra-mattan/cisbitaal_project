...
SECRET_KEY = 'django-insecure-9=51@vh90eass6ttc66gq*x_6l=b8p*6ohnu#v@av#&ch=)&!u'
...
# Haddii uu jiro DATABASE_URL (sida Render), isticmaal. 
# Haddii kale, isticmaal MySQL-ka maxalliga ah ee Laragon.
